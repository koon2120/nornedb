...
useSeoMeta({
  title: `นโยบายความเป็นส่วนตัว - ${appConfig.website_name}`,
  ogTitle: `นโยบายความเป็นส่วนตัว - ${appConfig.website_name}`,
...
<template>
  <h1 class="text-center mt-5"><strong>นโยบายความเป็นส่วนตัว</strong></h1>
  <div class="mt-4">
    <p>
      NorneDB ให้ความสำคัญกับการคุ้มครองข้อมูลส่วนบุคคลของคุณ
    ...
    <p>
      ...
      โดยคุณสามารถทราบข้อกำหนดและเงื่อนไขนโยบายที่มีการแก้ไขเปลี่ยนแปลงนี้ได้ผ่านทางเว็บไซต์ของเรา<br />
      นโยบายนี้แก้ไขล่าสุดและมีผลใช้บังคับตั้งแต่วันที่ 01 กรกฎาคม 2567
    </p>
    <br />
    ...
    <p>
      ...
      คุณสามารถติดต่อเราหรือเจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคลของเราได้ ดังนี้<br />
      อีเมล contact@nornedb.online
    </p>
    <br />
  </div>
</template>
